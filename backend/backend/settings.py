...
SECRET_KEY = 'django-insecure-s$0q8r-pkwk6024-*g%gl@=59^*d5pqvty)&=_x4y7c76rgb+u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['https://myapp2-pzj8.onrender.com/']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = "MyApp2 chinedujosiahstu@gmail.com"
