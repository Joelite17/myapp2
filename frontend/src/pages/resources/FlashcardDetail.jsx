            ...
            <div className="absolute inset-0 bg-green-100 dark:bg-green-800 rounded-lg shadow-lg p-4 flex flex-col overflow-hidden rotate-y-180 backface-hidden">
              <div
                className={`flex-1 p-2 overflow-y-auto ${
                  flashcards[current].type === "plain"
                    ? "flex flex-col items-center justify-center" // center horizontally, scroll vertically
                    : "flex flex-col items-start justify-start" // top-left for list
                }`}
              >
                <p
